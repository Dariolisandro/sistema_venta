...
class UpdateRquest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email'=>'required|string|max:200|unique:priveders' ,$this->route
            ('provider')->id.'|max:11',

            'rut'=>'required|string|max:11|min:11|unique:priveders' ,$this->route
            ('provider')->id.'|max:11',

            'address'=>'nul|string|max:50', 

            'phone'=>'required|string|max:9|min:9',$this->route
            ('provider')->id.'|max:11',
