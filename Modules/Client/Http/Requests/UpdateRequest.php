...
class UpdateRequest extends FormRequest
{
    public function rules()
    {
        return [
            ...
            'phone'=>'string|required|unique:clients,phone|max:8',$this ->route 
            ('client')->id.'max:50',      

            'email'=>'string|required|unique:clients,email|max:255|email:rfc,dns',$this ->route 
            ('client')->id.'max:50',   
            ...
            'rut'=>'string|requered|unique:clients,rut|max:11',$this ->route 
            ('client')->id.'max:50',      
